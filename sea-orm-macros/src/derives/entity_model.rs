...
use syn::{
    ...
    ExprLit, Fields, Lit, LitStr, Meta, Type,
};
            ...
            for meta in list.iter() {
                if let Meta::NameValue(nv) = meta {
                    if let Some(ident) = nv.path.get_ident() {
                        ...
                        } else if ident == "table_name_expr" {
                            match &nv.lit {
                                Lit::Str(str) => {
                                    table_name = Some(str.parse::<Expr>()?);
                                }
                                _ => {
            ...
            match table_name {
                Expr::Lit(lit) => {
                    ...
                    columns_enum.push(quote! {
                        #[doc = " Generated by sea-orm-macros"]
                        #[sea_orm(table_name=#lit)]
                        #[strum(disabled)]
                        #table_field_name
                    });
                }
                _ => {
                    let table_name = table_name.into_token_stream();
                    columns_enum.push(quote! {
                        #[doc = " Generated by sea-orm-macros"]
                        #[sea_orm(table_name_expr=#table_name)]
                        #[strum(disabled)]
                        #table_field_name
                    });
                }
